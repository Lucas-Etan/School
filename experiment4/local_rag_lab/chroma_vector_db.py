...
def get_client(path: str = "experiment4/local_rag_lab/index/chroma_db"):
...
def build_chroma_store(corpus_path: str = "experiment4/local_rag_lab/docs/genshin_corpus.json") -> None:
