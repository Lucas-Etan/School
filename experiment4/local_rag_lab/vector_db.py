...
def build_vector_store(
    corpus_path: str = "experiment4/local_rag_lab/docs/genshin_corpus.json",
    output_path: str = "experiment4/local_rag_lab/index/vector_store.json",
) -> None:
...
def load_vector_store(path: str = "experiment4/local_rag_lab/index/vector_store.json") -> list[dict]:
    """读取轻量向量库记录。"""
